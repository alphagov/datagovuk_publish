...
var test_create_weekly = function (browser) {
  goToCreateFrequency(browser)
    ...
    .clearSetValue('#id_url', common.validDataUrl)
    .clearSetValue('#id_name', common.datafileTitle)
    .clearSetValue('#start_day', '30')
    .clearSetValue('#start_month', '01')
    .clearSetValue('#start_year', '2012')
    .clearSetValue('#end_day', '30')
    .clearSetValue('#end_month', '01')
    .clearSetValue('#end_year', '2013')
    .submitFormAndCheckNextTitle('Links to your data')
    ...
    .clearSetValue('#start_day', '30')
    .clearSetValue('#start_month', '01')
    .clearSetValue('#start_year', '2013')
    .clearSetValue('#end_day', '30')
    .clearSetValue('#end_month', '01')
    .clearSetValue('#end_year', '2014')
    .submitFormAndCheckNextTitle('Links to your data')
...
var test_create_monthly_bad_month = function (browser) {
  goToCreateFrequency(browser)
    ...
    .clearSetValue('#id_url', common.validDataUrl)
    .clearSetValue('#id_name', common.datafileTitle)
    .clearSetValue('#start_month', 'Movember')
    .clearSetValue('#start_year', '2016')
    .submitFormAndCheckNextTitle('There was a problem')
