...
describe "managing datasets" do
  ...
  let!(:dataset_1) { FactoryBot.create(:dataset, title: "Cats per square mile", organisation:) }
  let!(:dataset_2) { FactoryBot.create(:dataset, title: "Dogs per square mile", organisation:) }
  ...
  it "paginates datasets" do
    FactoryBot.create(:dataset, organisation:) # create a third dataset
    datasets_per_page = 2
